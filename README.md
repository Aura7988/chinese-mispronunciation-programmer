...
| content [🔊](https://www.merriam-webster.com/dictionary/content?pronunciation&lang=en_us&dir=c&file=conten04) | /ˈkɑntɛnt/       | /ˈkɒntent/           | \ˈkän-ˌtent\                             |
| deque [🔊](http://dict.youdao.com/dictvoice?audio=deque&type=2) | /dɛk/            | /dek/                |                                          |
| digest [🔊](http://dict.youdao.com/dictvoice?audio=digest&type=2) | /ˈdɑɪdʒɛst/      | /ˈdɑɪdʒest/          | \ˈdī-ˌjest\                              |
...
注4：表中只给出程序员常用的释义对应的读音，其他释义下可能有其他读音，不一一列出。如只给出content用作“目录”时的读音，不给出用作“满意的”时的读音。
